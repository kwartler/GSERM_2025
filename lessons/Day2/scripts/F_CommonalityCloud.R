...
chardonnay <- 'https://raw.githubusercontent.com/kwartler/teaching-datasets/refs/heads/main/chardonnay.csv'
coffee     <- 'https://raw.githubusercontent.com/kwartler/teaching-datasets/refs/heads/main/coffee.csv'
